...
export class IdeaService {
  ...
  constructor(private afs: AngularFirestore) {
    ...
    // snapshotchanges or valuechanges
    // Use pipe and map to get doc's ID
  ...
  // Gets single ideas, take(1) takes 1 value from the observables 
  // b/c we don't need real-time live update binding
